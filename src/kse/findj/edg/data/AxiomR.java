...
public class AxiomR implements MyAxiom, Serializable {
	 ...
	 */
	public AxiomR(int leftCl, int rightProp, int rightCl) {
	...
	public String toString() {
		return "AxiomR [subClass=" + subClass + ", propertyInSuperClass="
				+ propertyInSuperClass + ", classInSuperClass="
				+ classInSuperClass + ", sha1=" + sha1 + "]";
	}
	
	public String getAxiomDescription(){
		return "AxiomR [" + subClass + "[=-]" + propertyInSuperClass + "." + classInSuperClass + "]";
	}
